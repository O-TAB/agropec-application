...
export default function NavbarComponents() {
    ...
    return(<header className="bg-green-600 shadow-lg pb-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:block">
              <button className="bg-white text-green-600 px-6 py-2 rounded-full font-semibold hover:bg-green-50 transition-colors shadow-md">
                Dúvidas?
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-green-700 rounded-lg mb-4 p-4">
              ...
              />
              {/* <button className="bg-white text-green-600 px-6 py-2 rounded-full font-semibold hover:bg-green-50 transition-colors shadow-md w-full mt-4">
                Dúvidas?
              </button> */}
            </div>
          )}
